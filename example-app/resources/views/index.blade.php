                ...
                <table class="table table-responsive table-bordered table-stripped" style="margin-top:10px;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span type="button" class="btn btn-{{$employee->is_active == 1?'success':'danger'}} btn-xs py-0">{{$employee->is_active == 1?'Active':'In-Active'}}</span>
                            </td>

                            <td>
                                <div class="d-flex">
                                    <a href="{{route('employee.show',$employee->id)}}" class="btn btn-primary btn-xs py-0 mx-1">Show</a>
                                    <a href="{{route('employee.edit',$employee->id)}}" class="btn btn-warning btn-xs py-0 mx1">Edit</a>
